...
const char* archive_get_flipper_app_name(ArchiveFileTypeEnum file_type) {
    ...
    case ArchiveFileTypeSubghzPlaylist:
        return EXT_PATH("apps/Sub-GHz/Automate/subghz_playlist.fap");
    case ArchiveFileTypeSubghzRemote:
        return EXT_PATH("apps/Sub-GHz/Automate/subghz_remote.fap");
    case ArchiveFileTypeProtoPirate:
        return EXT_PATH("apps/Sub-GHz/Analyze/proto_pirate.fap");
    case ArchiveFileTypeInfraredRemote:
        return EXT_PATH("apps/Infrared/Remotes/ir_remote.fap");
    case ArchiveFileTypeBadUsb:
        return "Bad KB";
    case ArchiveFileTypeWAV:
        return EXT_PATH("apps/Media/Audio/wav_player.fap");
    case ArchiveFileTypeMag:
        return EXT_PATH("apps/GPIO/Security/magspoof.fap");
    case ArchiveFileTypeCrossRemote:
        return EXT_PATH("apps/Infrared/Remotes/xremote.fap");
    case ArchiveFileTypePicopass:
        return EXT_PATH("apps/NFC/Credentials/picopass.fap");
...
static void archive_show_file(Loader* loader, const char* path) {
    ...
    if(text) {
        loader_start_detached_with_gui_error(
            loader, EXT_PATH("apps/Tools/System/text_viewer.fap"), path);
    } else {
        loader_start_detached_with_gui_error(
            loader, EXT_PATH("apps/Tools/System/hex_viewer.fap"), path);
    }
}
