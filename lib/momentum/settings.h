...
#define NUEROLYNX_SETTINGS_PATH       INT_PATH(".nuerolynx_settings.txt")
#define LEGACY_MOMENTUM_SETTINGS_PATH INT_PATH(".momentum_settings.txt")
// Compatibility alias used by bundled applications built against the extended settings API.
#define MOMENTUM_SETTINGS_PATH NUEROLYNX_SETTINGS_PATH
