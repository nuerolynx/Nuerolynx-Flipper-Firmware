...
from fbt.nlx_app_library import get_nlx_app_library_category
...
class AppBuilder:
    ...
    def _build_app(self):
        ...
        if self.app.apptype == FlipperAppType.PLUGIN:
            ...
            library_category = get_nlx_app_library_category(self.app)
            fap_path = f"apps/{library_category}/{app_artifacts.compact.name}"
