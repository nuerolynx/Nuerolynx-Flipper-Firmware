...
void flipper_migrate_files() {
    ...
    const struct {
        ...
        {EXT_PATH(".config/nuerolynx_settings.txt"), NUEROLYNX_SETTINGS_PATH},
        {EXT_PATH(".config/momentum_settings.txt"), NUEROLYNX_SETTINGS_PATH},
        {EXT_PATH(".config/xtreme_settings.txt"), NUEROLYNX_SETTINGS_PATH},
