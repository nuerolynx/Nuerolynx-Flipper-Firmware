...
static void
    ...
    if(furi_string_equal(label, "Nuerolynx")) {
        furi_string_set(label, "NLX");
...
MomentumApp* momentum_app_alloc() {
    ...
    // Keep the settings header to the release name only. Appending the build
    // date makes "Nuerolynx v1.1" overflow the 128 px display.
